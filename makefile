...
build:
	go build -o bin/terraform-provider-keycloak
...
build-example: build
	...
	cp bin/terraform-provider-keycloak example/.terraform/plugins/terraform.local/mrparkers/keycloak/3.0.0/darwin_amd64/
	cp bin/terraform-provider-keycloak example/terraform.d/plugins/terraform.local/mrparkers/keycloak/3.0.0/darwin_amd64/
